...
|----|---------|----------|----------|---------|-------------|-------|-----------|--------|
| 01 | `plans/01-procedencia.md` | OBRIGATÓRIO | sempre | `Origem` no schema, no parser e nos gates, com bloqueio de `premissa` em Must/P0 e resolução de path | nenhuma | CN2, CN3, CN5, VC1, LEG2, INV1, INV2 | nenhuma | CONCLUÍDO (2026-08-06) |
