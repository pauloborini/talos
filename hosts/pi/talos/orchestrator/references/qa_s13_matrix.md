...
|---|---|---|
| Claude Code | `<install>/claude` | `2.1.159 (Claude Code)` |
| Cursor Agent | `<install>/cursor-agent` | logged in as `cursor-agent@local` |
| Codex CLI | `<install>/codex` | `codex-cli 0.135.0-alpha.1` |
