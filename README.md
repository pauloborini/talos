...
Plugin **Atlas Workflow Orchestrator** v0.9.2 — pipeline determinístico (PRD → plano → execução → validação) com skills `atlas-*`, templates e MCP. Um pacote, seis hosts: **Claude Code**, **Cursor**, **Codex App**, **Antigravity (Gemini)**, **OpenCode** e **Pi CLI**.

**Versão:** [`VERSION`](VERSION) (`0.9.2`) · **Repo:** https://github.com/pauloborini/atlas-workflow
