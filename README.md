...
Plugin **Atlas Workflow Orchestrator** v0.7.1 — pipeline determinístico (PRD → plano → execução → validação) com skills `atlas-*`, templates e MCP. Um pacote, cinco hosts: **Claude Code**, **Cursor**, **Codex App**, **OpenCode** e **Pi CLI**.

**Versão:** [`VERSION`](VERSION) (`0.7.1`) · **Repo:** https://github.com/pauloborini/atlas-workflow
